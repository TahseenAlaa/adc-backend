...
//        Route::get('/index/{patient_id}', [TreatmentController::class, 'index'])->name('index'); //
    ...
    Route::prefix('/documents')->name('documents.')->middleware(['auth:sanctum', 'can:list inventory'])->group(function () {
        ...
        Route::post('/delete-input-document', [DocumentsController::class, 'destroyInputDocument'])->name('delete-input-document');
        Route::post('/delete-output-document', [DocumentsController::class, 'destroyOutputDocument'])->name('delete-output-document');
        ...
        Route::post('/show-document-with-details', [DocumentsController::class, 'showDocumentWithDetails'])->name('show-document-with-details');
    ...
    Route::prefix('/committee-approval')->name('committee-approval.')->middleware(['auth:sanctum', 'can:access committee approval'])->group(function () {
        ...
        Route::post('/store', [CommitteeApprovalController::class, 'store'])->name('store');
    });
