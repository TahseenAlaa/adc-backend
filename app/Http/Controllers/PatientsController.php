...
//        ], 500);
    ...
    public function update(Request $request) {
        ...
        $updatePatient = Patients::where('uuid', '=', $request->patient_uuid)->update([
            ...
            'weight_baby'                 => $request->weight_of_baby_at_birthday,
            'hypertension'                => $request->hypertension,
            'family_ihd'                  => $request->family_history_of_ihd,
            ...
            'non_proliferative'           => $request->non_proliferative,
            'proliferative_dr'            => $request->proliferative_dr,
            'maculopathy'                 => $request->maculopathy,
            'insulin'                     => $request->insulin,
            'amputation'                  => $request->amputation,
            'ed'                          => $request->ed,
            'nafld'                       => $request->nafld,
            'dermopathy'                  => $request->dermopathy,
            'diabetic_food'               => $request->diabetic_food,
            'date_insulin'                => $request->date_insulin,
            'duration_insulin'            => Carbon::parse($request->date_insulin)->age,
            'date_dm'                     => $request->date_of_dm,
            'duration_dm'                 => Carbon::parse($request->date_of_dm)->age,
            'glycemic_control'            => $request->glycemic_control,
            'lipid_control'               => $request->lipid_control,
            'pressure_control'            => $request->pressure_control,
            'first_a1c'                   => $request->first_a1c,
        ...
        $requestContent = new Request();
        $requestContent->patient_uuid = $request->patient_uuid;

        return $this->showPatientInfo($requestContent);
